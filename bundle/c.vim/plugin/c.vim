...
if	s:MSWIN
  ...
  " ==========  Linux/Unix  ======================================================
	...
	if match( expand("<sfile>"), expand("$HOME") ) == 0
		...
		let s:installation					= 'system'
		"let s:plugin_dir						= $VIM.'/vimfiles/'
		let s:plugin_dir						= $VIM.'/bundle/c.vim/vimfiles/'
		let s:C_GlobalTemplateDir		= s:plugin_dir.'c-support/templates'
		let s:C_GlobalTemplateFile  = s:C_GlobalTemplateDir.'/Templates'
	endif
	"
	...
	let s:C_IndentErrorLog				= $HOME.'/.vim/bundle/c.vim/indent.errorlog'
	"
  let s:escfilename 	= ' \%#[]'
...
function! C_Compile ()
	...
	if !filereadable(Obj) || (filereadable(Obj) && (getftime(Obj) < getftime(Sou)))
		...
		exe		"make ".s:C_CFlags." ".SouEsc." -I /Users/colin/data/bin/cheaders -o ".ObjEsc
